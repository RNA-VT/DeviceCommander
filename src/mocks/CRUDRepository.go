...
func (_m *CRUDRepository) Create(_a0 model.NewDevice) (*model.Device, error) {
	ret := _m.Called(_a0)
...
func (_m *CRUDRepository) Delete(_a0 string) (*model.Device, error) {
	ret := _m.Called(_a0)
...
func (_m *CRUDRepository) Get(_a0 model.Device) ([]*model.Device, error) {
	ret := _m.Called(_a0)
...
func (_m *CRUDRepository) GetAll() ([]*model.Device, error) {
	ret := _m.Called()
...
func (_m *CRUDRepository) Update(_a0 model.UpdateDevice) error {
	ret := _m.Called(_a0)
