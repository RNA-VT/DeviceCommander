...
func (_m *Repository) Create(_a0 model.NewDevice) (*model.Device, error) {
	ret := _m.Called(_a0)
...
func (_m *Repository) Delete(_a0 string) (*model.Device, error) {
	ret := _m.Called(_a0)
...
func (_m *Repository) Get(_a0 model.Device) ([]*model.Device, error) {
	ret := _m.Called(_a0)
...
func (_m *Repository) GetAll() ([]*model.Device, error) {
	ret := _m.Called()
...
func (_m *Repository) Update(_a0 model.UpdateDevice) error {
	ret := _m.Called(_a0)
